...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-gray-900 via-gray-950 to-black border-t border-gray-800 py-16 px-6 overflow-hidden text-gray-300">
      {/* --- Background Effects --- */}
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 via-blue-600/5 to-purple-700/5"></div>

      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 -left-10 w-72 h-72 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 -right-10 w-72 h-72 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      {/* --- Footer Content --- */}
      <div className="relative max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
        {/* 1️⃣ - About */}
        <div>
        ...
        <div>
          ...
          <div className="flex justify-center md:justify-start space-x-4">
            ...
            <a
              ...
              className="p-2 rounded-full bg-gray-800/40 hover:bg-cyan-500/20 hover:scale-110 transition-all"
            >
              <Linkedin className="text-gray-300 hover:text-white" size={22} />
            </a>
            <a
      ...
      {/* --- Divider + Copyright --- */}
      <div className="relative max-w-6xl mx-auto mt-12 pt-6 border-t border-gray-800 text-center text-sm text-gray-500">
        <p>
        ...
        <button
          onClick={scrollToTop}
          className="absolute right-6 -top-8 p-2 rounded-full bg-cyan-600/20 hover:bg-cyan-600/40 transition-all text-cyan-400"
